...
Aliases to be aware of:
  ...
  i_branch = br, br1                        i_branchConstraint = brCst
...
* Market node constraint
  ...
  MNodeReserveOfferConstraintFactors(tp,MnodeCstr,o,resT)           'Market node reserve offer constraint factors for the current trading period'
...
* Valid reserve offer/bid blocks
  validReserveOfferBlock(tp,o,trdBlk,resT)                          'Valid trade blocks for the respective reserve offers by class and type'
  ;

Parameters
* Reserve offer
  ReserveOfferProportion(tp,o,trdBlk)                               'The percentage of the MW block available for PLSR'
  ReserveOfferPrice(tp,o,trdBlk,resT)                               'The price of the reserve of the different reserve classes and types ($/MW)'
  ReserveOfferMaximum(tp,o,trdBlk,resT)                             'The maximum MW offered reserve for the different reserve classes and types (MW)'
  ReserveOfferFactor(tp,o,resC,resT)                                'The maximum MW offered reserve for the different reserve classes and types (MW)'
...
Positive variables
* Reserve
  RESERVEBLOCK(tp,o,trdBlk,resT)                   'MW Reserve scheduled from the individual trade blocks of an offer'
  RESERVE(tp,o,resT)                               'MW Reserve scheduled from an offer'
  RESERVECLASS(tp,o,resC)                          'Effective MW scheduled from an offer for the different reseve class'
* Island reserve
...
* Risk
  ...
  RiskOffsetCalculation_DCCE(tp,ild,resC,riskC)          'Calculation of the risk offset variable for the DCCE risk class. (3.4.1.2)'
  RiskOffsetCalculation_DCECE(tp,ild,resC,riskC)         'Calculation of the risk offset variable for the DCECE risk class. (3.4.1.4)'
...
* Reserve
  PLSRReserveProportionMaximum(tp,o,trdBlk,resT)         'Maximum PLSR as a proportion of the block MW (3.4.2.1)'
  ReserveOfferDefinition(tp,o,resT)                      'Definition of the reserve offers of different types (3.4.2.3a)'
  EnergyAndReserveMaximum(tp,o,resC)                     'Definition of maximum energy and reserves from each generator (3.4.2.4)'
  EffectiveReserveClassDefinition(tp,o,resC)             'Definition of the effective reserve for different classes (Testing)'
...
*===================================================================================
* 3b. New reserve model + NMIR testing
*===================================================================================
* Declaration of sets, parmeter, variables and equations for NMIR
Sets
  i_dczone(*)                              'Defined reverse reserve sharing zone for HVDC sent flow: RP -> round power zone, NR -> no reverse zone, RZ -> reverse zone'
;
Alias (i_dczone,z,z1,rrz,rrz1) ;
...
;
*===================================================================================
* New reserve model + NMIR testing end
*===================================================================================
...
- sum[ validReserveOfferBlock(currTP,o,trdBlk,resT)
...
+ sum[ (o,resT) $ offer(currTP,o)
       , MNodeReserveOfferConstraintFactors(currTP,MnodeCstr,o,resT)
       * RESERVE(currTP,o,resT)
     ]
...
* Calculation of the risk offset variable for the DCCE risk class. 3.4.1.2)
...
* Calculation of the risk offset variable for the DCECE risk class.(3.4.1.4)
...
=e=
  ...
  * [ GENERATION(currTP,o)
    ...
    + FKBand(currTP,o)
    + RESERVECLASS(currTP,o,resC)
    + sum[ o1 $ {PrimarySecondaryOffer(currTP,o,o1) and UsePrimSecGenRiskModel}
         , RESERVECLASS(currTP,o1,resC) + GENERATION(currTP,o1) ]
    ]
* NMIR update
...
PLSRReserveProportionMaximum(offer(currTP,o),trdBlk,PLSRReserveType)
  $ validReserveOfferBlock(offer,trdBlk,PLSRReserveType)..
  RESERVEBLOCK(Offer,trdBlk,PLSRReserveType)
=l=
  ReserveOfferProportion(Offer,trdBlk) * GENERATION(Offer)
  ;

* Definition of the reserve offers of different classes and types (3.4.3.3a)
ReserveOfferDefinition(offer(currTP,o),resT)..
  RESERVE(offer,resT)
=e=
  sum[ trdBlk, RESERVEBLOCK(offer,trdBlk,resT) ]
  ;
...
+ ReserveMaximumFactor(offer,resC)
  * sum[ resT $ (not ILReserveType(resT)), RESERVE(offer,resT) ]
=l=
  ReserveGenerationMaximum(offer)
  ;

* Definition of the effective reserve for different classes (Testing)
EffectiveReserveClassDefinition(offer(currTP,o),resC)..
  RESERVECLASS(offer,resC)
=e=
  sum[ resT, ReserveOfferFactor(offer,resC,resT) * RESERVE(offer,resT) ]
  ;
...
IslandReserveCalculation(currTP,ild,resC)..
  ISLANDRESERVE(currTP,ild,resC)
=l=
  Sum[ o $ { offer(currTP,o) and offerIsland(currTP,o,ild) }
                , RESERVECLASS(currTP,o,resC)
     ]
  ;
...
* Reserve
  ...
  EffectiveReserveClassDefinition
* Matching of reserve requirement and availability
